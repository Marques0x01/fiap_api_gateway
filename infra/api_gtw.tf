...
resource "aws_api_gateway_resource" "proxy_kitchen" {
  rest_api_id = aws_api_gateway_rest_api.api_gtw.id
  parent_id   = aws_api_gateway_resource.proxy.id
  path_part   = var.resource_path_kitchen

  depends_on = [aws_api_gateway_resource.proxy]
}

resource "aws_api_gateway_resource" "proxy_client" {
  rest_api_id = aws_api_gateway_rest_api.api_gtw.id
  parent_id   = aws_api_gateway_resource.proxy.id
  path_part   = var.resource_path_client
